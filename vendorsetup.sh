...
git clone --depth=1 https://github.com/ProjectElixir-Devices/vendor_oneplus_lemonades.git -b tiramisu vendor/oneplus/lemonades
...
git clone --depth=1 https://github.com/Evolution-X-Devices/kernel_oneplus_sm8250.git -b tiramisu kernel/oneplus/sm8250

echo 'Cloning Hardware Oplus [5/7]'
# Hardware Oplus
rm -rf hardware/oplus
git clone --depth=1 https://github.com/ProjectElixir-Devices/hardware_oplus.git -b qpr3 hardware/oplus
